...
void send_hdd(http_state_t *hs) {
    ...
    fprintf(page, "<title>Dream Web Console - Hard Drive Management</title></head></html>\n<body>\n");
    fprintf(page, "<h1>Dream Web Console - Hard Drive Management</h1>\n");
    fprintf(page, "<p>The HDD management page is currently unimplemented. Come back later for more.</p>\n");
