...
void send_vmu(http_state_t *hs) {
    ...
    fprintf(page, "<title>Dream Web Console - VMU Management</title></head></html>\n<body>\n");
    fprintf(page, "<h1>Dream Web Console - VMU Management</h1>\n");
    fprintf(page, "<p>The VMU management page is currently unimplemented. Come back later for more.</p>\n");
